...
for img_file in my_pic :
    ...
    Brown_class[0].extend(R.tolist())
    Brown_class[1].extend(G.tolist())
    Brown_class[2].extend(B.tolist())



my_brownclass = open('brownclass.pkl','wb')
pickle.dump(Brown_class,my_brownclass)
my_brownclass.close()
