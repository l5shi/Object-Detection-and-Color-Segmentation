...
for img_file in my_pic :
    ...
    NotBarrelRed_class[0].extend(R.tolist())
    NotBarrelRed_class[1].extend(G.tolist())
    NotBarrelRed_class[2].extend(B.tolist())



my_nbredclass = open('NotBarrelRedclass.pkl','wb')
pickle.dump(NotBarrelRed_class,my_nbredclass)
my_nbredclass.close()
